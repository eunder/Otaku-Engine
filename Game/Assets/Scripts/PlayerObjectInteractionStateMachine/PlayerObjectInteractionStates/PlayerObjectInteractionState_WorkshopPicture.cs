...
public class PlayerObjectInteractionState_WorkshopPicture : IPlayerObjectInteractionState 
{
        bool entered = false;
    ...
    public IPlayerObjectInteractionState DoState(PlayerObjectInteractionStateMachine playerObjectInteraction)
    {
        ...
        return playerObjectInteraction.PlayerObjectInteractionStateWorkshopPicture;
    }
        ...
        void OnEnter(PlayerObjectInteractionStateMachine playerObjectInteraction)
    {
        ...
        void OnExit(PlayerObjectInteractionStateMachine playerObjectInteraction)
        {
            if(playerObjectInteraction.toolTipText != null)
            {
                ...
                GameObject.FindObjectOfType<UploadManager>().imageThunbmailPath = Application.dataPath + "/StreamingAssets/" + "workshop_picture.png";
                GameObject.FindObjectOfType<UploadManager>().LoadImage();

                if(playerObjectInteraction.aiWife_anim != null)
                {
